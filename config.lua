...
RollDice.ChatCommand = "zarat" --Command name.
...
RollDice.ShowTime = 5 -- Time in seconds on how long the players can see the RollDice.
RollDice.Offset = 1.9 --Changes the z axis of the 3d text displayed.
